...
import { enableTaskStatusOptions } from '@/constants/business';
...
const model = defineModel<Api.TaskManage.TaskSearchParams>('model', { required: true });
...
const taskStatusOptions = translateOptions(
  enableTaskStatusOptions as unknown as CommonType.Option<string>[]
) as unknown as CommonType.Option<string>[];
</script>
      ...
      <ARow :gutter="[16, 16]" wrap>
        <ACol :span="24" :md="12" :lg="6">
          <AFormItem :label="$t('page.manage.task.taskName')" name="taskName" class="m-0">
            <AInput v-model:value="model.taskName" :placeholder="$t('page.manage.task.form.taskName')" />
          </AFormItem>
        </ACol>
        <ACol :span="24" :md="12" :lg="6">
        ...
        <ACol :span="24" :md="12" :lg="6">
          <AFormItem :label="$t('page.manage.task.taskStatus')" name="taskStatus" class="m-0">
            <ASelect
              v-model:value="model.taskStatus"
              :placeholder="$t('page.manage.task.form.taskStatus')"
