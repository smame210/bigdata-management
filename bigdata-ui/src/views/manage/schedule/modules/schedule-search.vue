...
import { enableScheduleStatusOptions } from '@/constants/business';
...
const model = defineModel<Api.ScheduleManage.ScheduleSearchParams>('model', { required: true });
  ...
  <ACard :title="$t('common.search')" :bordered="false" class="card-wrapper">
    ...
    >
      <ARow :gutter="[16, 16]" wrap>
        ...
        <ACol :span="24" :md="12" :lg="6">
          <AFormItem :label="$t('page.manage.schedule.scheduleStatus')" name="scheduleStatus" class="m-0">
            <ASelect
              v-model:value="model.scheduleStatus"
              :placeholder="$t('page.manage.schedule.form.scheduleStatus')"
              :options="translateOptions(enableScheduleStatusOptions as unknown as CommonType.Option<string>[])"
              allow-clear
            />
          </AFormItem>
        </ACol>
